...
def write_html_class(class_name, instructor_first, instructor_last, instructor_email):
    html = '''

            <div class="alert">
                <h2>{class_name}  -- {last}, {first}  -- Email: {email}</h2>
                <div class="content">
...
'''.format(class_name=class_name, last=instructor_last, first=instructor_first, email=instructor_email)
...
def update_html():
    ...
    for name in classes:
        ...
        write_html_class(name, info['first'], info['last'], info['email'])
