...
def create_class(args):                                                                                                                                                                                        
        ...
        container = cli.create_container(image='jupyterhub/cgrb:v'+args.version,                                                                                                                               
                        command='/bin/bash',                                                                                                                                                                   
        ...
        #initialize = cli.exec_create(container=args.class_name, cmd = '/srv/initialize_jupyterhub.sh')
        #response = cli.exec_start(initialize.get('Id'))
        #print(response)

        create_user = cli.exec_create(container=args.class_name, cmd = '/opt/anaconda/bin/python /home/jupyter_python/manage_users.py -a '+args.first+' '+args.last+' '+args.user+' '+args.email+' instructor True')
